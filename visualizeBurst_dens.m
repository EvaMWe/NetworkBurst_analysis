function visualizeBurst_dens(rateDiff, burstStart, burstStop, spikeTime)
...
%% spiketrain
firstPos = min(spikeTime);
lastPos =max(spikeTime);
nbSamples = ceil(lastPos-firstPos);
spikeSamples = spikeTime;
